...
describe "Smoke test" do
  ...
  it "meter" do
    ...
    expect(datapoints[:counter][0][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][1][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][2][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][3][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][4][:tags]).to include(:env => "test")
  ...
  it "timer" do
    ...
    expect(datapoints[:counter][5][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][6][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][7][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][8][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][9][:tags]).to include(:env => "test")
    ...
    expect(datapoints[:counter][10][:tags]).to include(:env => "test")
  ...
  it "gauge" do
    ...
    expect(datapoints[:gauge][0][:tags]).to include(:env => "test")
